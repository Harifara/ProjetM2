...
MIDDLEWARE = [
    ...
    "stock.middleware.AuthServiceMiddleware",
    "stock.middleware.AuditLogMiddleware",
]
...
DATABASES = {
    "default": {
        ...
        "HOST": config("DB_HOST", default="stock_db"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "stock.authentication.AuthServiceJWTAuthentication",
