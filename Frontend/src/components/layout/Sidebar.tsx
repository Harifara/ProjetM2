...
import {
  Users, DollarSign, Bell, Briefcase, ScrollText,
  LayoutDashboard, Settings, Package, UserCircle,
  FileText, Calendar, MapPin, CreditCard, ShoppingCart, LogOut
} from 'lucide-react';
...
const navigation = [
  ...
  // RH Section
  { name: 'Employés', href: '/rh/employees', icon: UserCircle, roles: ['admin','responsable_rh'] },
  { name: 'Contrats', href: '/rh/contracts', icon: FileText, roles: ['admin','responsable_rh'] },
  { name: 'Congés', href: '/rh/leave-requests', icon: Calendar, roles: ['admin','responsable_rh'] },
  { name: 'Affectations', href: '/rh/assignments', icon: MapPin, roles: ['admin','responsable_rh'] },
  ...
  { name: 'Fokontany', href: '/rh/fokontany', icon: MapPin, roles: ['admin','responsable_rh'] },
  { name: 'Paiements', href: '/rh/payments', icon: CreditCard, roles: ['admin','responsable_rh'] },
  { name: 'Achats', href: '/rh/purchases', icon: ShoppingCart, roles: ['admin','responsable_rh'] },

  { name: 'Stock', href: '/stock', icon: Package, roles: ['admin','responsable_stock','magasinier'] },
  { name: 'Finance', href: '/finance', icon: DollarSign, roles: ['admin','responsable_finance'] },
  { name: 'Projets', href: '/projects', icon: Briefcase, roles: ['admin','coordinateur'] },
  { name: 'Notifications', href: '/notifications', icon: Bell, roles: ['admin','responsable_rh','responsable_stock','responsable_finance','magasinier','coordinateur'] },
