...
ALLOWED_HOSTS = ["*", "localhost", "127.0.0.1", "auth_service", 'rh_service']
...
# Autoriser toutes les origines pour dev (production → spécifier)
...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "HS256",
    "SIGNING_KEY": config("JWT_SECRET", default="ajajamamy123"),
