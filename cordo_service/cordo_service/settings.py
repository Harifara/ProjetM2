...
SECRET_KEY = config("SECRET_KEY", default="cordo_service_secret_key_123")
...
ROOT_URLCONF = "cordo_service.urls"
WSGI_APPLICATION = "cordo_service.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="cordo_db"),
        "USER": config("DB_USER", default="postgres"),
        "PASSWORD": config("DB_PASSWORD", default="postgres"),
        "HOST": config("DB_HOST", default="cordo_db"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "cordo.authentication.KongJWTAuthentication",
    ),
